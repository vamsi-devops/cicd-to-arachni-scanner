#!/bin/bash
	...
	TOMCAT9_CORE_DOWNLOAD_URL="http://mirror.olnevhost.net/pub/apache/tomcat/tomcat-9/v$TOMCAT_VERSION/bin/$TOMCAT9_CORE_TAR_FILENAME"
	...
	tar -xvzf $TOMCAT9_CORE_TAR_FILENAME
