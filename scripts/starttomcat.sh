...
touch r2.html
./arachni http://18.176.249.162:8080/DemoPipelineJava-0.0.1-SNAPSHOT/ --checks=xss* >r2.html
...
aws s3 cp r2.html s3://arachni1/ --grants read=uri=http://acs.amazonaws.com/groups/global/AllUsers
