...
touch r1.html
./arachni http://18.223.114.39:8080/DemoPipelineJava-0.0.1-SNAPSHOT/ --checks=xss* >r1.html
...
aws s3 cp r1.html s3://archni/ --grants read=uri=http://acs.amazonaws.com/groups/global/AllUsers
