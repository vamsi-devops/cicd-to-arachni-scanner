...
./arachni http://13.234.98.68:8080/DemoPipelineJava-0.0.1-SNAPSHOT/ --checks=xss* --report-save-path=3.afr
./arachni_reporter 4.afr --reporter=html:outfile=my_report1.html.zip
mkdir repo1
unzip my_report1.html.zip -d repo1
cd repo1
mv index.html report1.html
